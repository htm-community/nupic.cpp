...
void setup(svm_parameter &obj) {
  ...
  obj.weight.push_back(1.1f);
  obj.weight.push_back(1.2f);
}
...
void setup(svm_problem01 &obj) {
  ...
  obj.y_.push_back(5.5f);
  obj.y_.push_back(52.5f);
}
...
void setup(svm_model &obj) {
  ...
  obj.w.resize(2);
  obj.w[0].push_back(33.1f);
  obj.w[0].push_back(12.1f);
  obj.w[1].push_back(3.1f);
  obj.w[1].push_back(1.1f);

  obj.rho.push_back(2.1f);
  obj.rho.push_back(21.1f);
  ...
  obj.probA.push_back(0.1f);
  obj.probA.push_back(0.2f);

  obj.probB.push_back(22.1f);
  obj.probB.push_back(0.3f);
  obj.probB.push_back(0.43f);
}
