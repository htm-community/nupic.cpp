...
namespace {
  ...
  TEST(TemporalMemoryTest, PunishMatchingSegmentsInInactiveColumns)
  {
    ...
    Synapse activeSynapse4 =
      tm.connections.createSynapse(matchingSegment, previousActiveCells[0], 0.5f);
    Synapse activeSynapse5 =
      tm.connections.createSynapse(matchingSegment, previousActiveCells[1], 0.5f);
  ...
  TEST(TemporalMemoryTest, ConnectionsNeverChangeWhenLearningDisabled)
  {
    ...
    tm.connections.createSynapse(correctActiveSegment,
                                 previousActiveCells[0], 0.5f);
    tm.connections.createSynapse(correctActiveSegment,
                                 previousActiveCells[1], 0.5f);
    tm.connections.createSynapse(correctActiveSegment,
                                 previousActiveCells[2], 0.5f);
  ...
  void serializationTestVerify(TemporalMemory& tm)
  {
    ...
    EXPECT_GE(winnerCell, (UInt)12);
    EXPECT_LT(winnerCell, (UInt)16);
