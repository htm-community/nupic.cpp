...
public:
  ...
  // These abstract functions must be implemented by the subclass.
  // Note: This should be mostly a binary serialization.
  //       A different text serialization can be used with operator overloads.
