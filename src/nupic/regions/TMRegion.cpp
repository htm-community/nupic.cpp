...
TMRegion::TMRegion(const ValueMap &params, Region *region)
  ...
  cellsSavePath_ = params.getString("cellsSavePath", "");
  logPathOutput_ = params.getString("logPathOutput", "");
  temporalImp_ = params.getString("temporalImp", "");
