...
namespace nupic
{
 ...
 //   typedef std::vector<std::string> StringVec;
    ...
    */
     ...
     * is Absolute("C:\foo\bar") -> true isAbsolute("\foo\bar") -> false on windows
     */
    ...
    /**
     * If source is a file, copy the file to the destination. if a folder, copy entire folder recursivly. 
     */
    ...
    */
    ...
    /**
    * For those people working with UTF16 wide character strings (wstring), here are some functions
    * to convert filenames to and from UTF8 narrow character strings (string).
    ***/
  ...
  // Global operators (concatination of filename)
